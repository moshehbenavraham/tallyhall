...
export function useAuth() {
  ...
  const signInWithOAuth = async (provider: 'google' | 'apple', redirectTo = window.location.origin) => {
  ...
  return { user, session, loading, profile, roles, hasRole, signIn, signInWithOAuth, signUp, signOut };
}
