...
export default function Dashboard() {
  ...
  const DONUT_COLORS = categoryPalette;
  ...
  return (
    <div className="space-y-5 sm:space-y-6">
      <SEO
        title="Dashboard"
        description="Your ExpenseDesk overview: recent expenses, spending trends, and category breakdown."
        path="/"
        noindex
      />
      {/* Header */}
              ...
              <CardContent className="pt-0">
                <ResponsiveContainer width="100%" height={200}>
                  <BarChart data={monthlyData} barSize={14}>
                    ...
                    <XAxis dataKey="day" tick={{ fontSize: 10, fill: axisTickColor }} axisLine={false} tickLine={false} />
