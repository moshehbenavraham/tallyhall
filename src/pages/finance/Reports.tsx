...
export default function Reports() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <SEO
        title="Reports"
        description="Finance reports: monthly trend, category breakdown, and status distribution across all expenses."
            ...
            {monthlyChartData.length === 0 ? (
              ...
              <ResponsiveContainer width="100%" height={250}>
                <BarChart data={monthlyChartData}>
                  ...
                  <XAxis dataKey="month" tick={{ fontSize: 10, fill: axisTickColor }} />
            ...
            {statusData.length === 0 ? (
              ...
              <ResponsiveContainer width="100%" height={220}>
                <BarChart data={statusData} layout="vertical">
                  <CartesianGrid strokeDasharray="3 3" stroke={gridStroke} />
                  <XAxis type="number" tick={{ fontSize: 10, fill: axisTickColor }} />
                  <YAxis dataKey="status" type="category" width={100} tick={{ fontSize: 10, fill: axisTickColor }} />
                  <Tooltip
                    contentStyle={tooltipContentStyle}
                    itemStyle={tooltipItemStyle}
                    labelStyle={tooltipLabelStyle}
