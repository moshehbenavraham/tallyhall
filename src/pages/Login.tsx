...
export default function Login() {
  ...
  // Clear any stale error message as soon as the user edits the form so the
  // alert region doesn't shout outdated copy at screen readers.
  useEffect(() => {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      toast({ title: 'Google sign in failed', description: fallback, variant: 'destructive' });
    } finally {
  ...
  return (
    <div className="flex min-h-screen">
      <SEO
        title="Sign in"
        description="Sign in to ExpenseDesk to submit, approve, and track team expenses."
        path="/login"
      />
